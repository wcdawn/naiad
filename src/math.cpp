...
double legendre(const int n, const double x)
{
  ...
  switch (n)
  {
    ...
    case (8):
      return (6435.0 * std::pow(x, 8) - 12012.0 * std::pow(x, 6) + 6930.0 * std::pow(x, 4) - 1260.0 * std::pow(x, 2) + 35.0) / 128.0;
    case (9):
      return (12155.0 * std::pow(x, 9) - 25740.0 * std::pow(x, 7) + 18018.0 * std::pow(x, 5) - 4620.0 * std::pow(x, 3) + 315.0 * x) / 128.0;
    case (10):
      return (46189.0 * std::pow(x, 10) - 109395.0 * std::pow(x, 8) + 90090.0 * std::pow(x, 6) - 30030.0 * std::pow(x, 4) + 3465.0 * std::pow(x, 2) - 63.0) / 256.0;
    default:
